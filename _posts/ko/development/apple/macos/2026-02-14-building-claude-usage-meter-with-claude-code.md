...
참고로 이 프로젝트에서 사람이 한 일은 "이거 만들어줘"라고 말한 것뿐이다. 앱 개발, GitHub 저장소 생성, 앱 아이콘 생성, 이 블로그 포스트 3개 국어 작성까지 전부 Claude Code가 알아서 했다. 본인은 옆에서 구경하다가 가끔 "그거 아닌데"라고 태클을 걸었을 뿐이다.
