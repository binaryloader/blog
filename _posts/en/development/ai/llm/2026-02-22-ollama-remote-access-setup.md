...
By default, Ollama only listens on `127.0.0.1:11434`. This works fine on the same PC, but to call the API from a Mac or other device, you need to allow external access.
