---
title: "[TIL] 2026-02-26"
ref: til-2026-02-26
excerpt: "LangChainのLCEL、プロンプトテンプレート、メッセージクラス、RunnableGeneratorを学習しながら学んだことをまとめる。"
date: 2026-02-26T20:20+09:00
last_modified_at: 2026-02-26T20:20+09:00
published: true
lang: ja
permalink: /ja/:categories/:title/
header:
  overlay_image: "/assets/image/thumbnail/header/til-2026-02-26.png"
  overlay_filter: "0"
  teaser: "/assets/image/thumbnail/teaser/ja/til-2026-02-26.png"
categories:
  - Study
  - TIL
tags:
...
LangChainのLCEL、プロンプトテンプレート、メッセージクラス、RunnableGeneratorを学習しながら学んだことをまとめる。
...
## 7. PyCharmで韓国語入力時のUnicodeEncodeError

PyCharmのコンソールでLangChainチェーンを実行し韓国語を入力すると、以下のようなエラーが発生することがある。

```
UnicodeEncodeError: 'utf-8' codec can't encode character '\udce3' in position 151: surrogates not allowed
```

`\udce3`はUTF-8 3バイトシーケンス（`0xe3`）のsurrogate形式である。PyCharmコンソールのエンコーディング設定の問題で韓国語入力がsurrogate文字に誤って変換され、Ollama APIに送信する際にUTF-8エンコーディングが失敗するのである。
...
ターミナルで正常に動作すれば、PyCharmコンソールのエンコーディング問題である。
