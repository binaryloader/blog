...
excerpt: "Xcode Agentic Coding AssistantにMCPサーバーを連携する方法をまとめる。"
...
header:
  ...
  overlay_filter: "0"
  teaser: "/assets/image/thumbnail/teaser/ja/xcode-agentic-coding-assistant-mcp-setup.png"
categories:
  - Development
  - Apple
  - Xcode
...
Xcode Agentic Coding AssistantにMCPサーバーを連携する方法をまとめる。
...
- `command`にはバイナリの絶対パスを入力する必要がある。nvmなどでNode.jsを管理している場合は`which npx`でパスを確認する。
