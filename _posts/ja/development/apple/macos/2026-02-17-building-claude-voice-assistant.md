...
夜眠れなくて始めたデモプロジェクトにしては思ったより使えるものになった。もちろんデモレベルなのでプロダクションで使えるものではないが「Claude Codeに音声を載せられるか？」という問いへの答え程度にはなった。
