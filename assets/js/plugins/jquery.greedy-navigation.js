...
$(function() {
  ...
  var $langDropdown = $('nav.greedy-nav .lang-dropdown');
  ...
  function check() {
    ...
    availableSpace = /* nav */ $nav.innerWidth()
                   ...
                   - /* theme */ ($themeToggle.length !== 0 ? $themeToggle.outerWidth(true) : 0)
                   - /* lang */ ($langDropdown.length !== 0 ? $langDropdown.outerWidth(true) : 0)
